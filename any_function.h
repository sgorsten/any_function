...
private:
    ...
    template<class F, class R, class... A, size_t... I> any_function(F f, tag<R   >, tag<A...>, indices<I...>)  : parameter_types({type::capture<A>()...}), result_type(type::capture<R   >()) { func = [f](void * const args[]) { return result::capture<R   >(f(get(args[I], tag<A>{})...));          }; }
    template<class F, class R, class... A, size_t... I> any_function(F f, tag<R & >, tag<A...>, indices<I...>)  : parameter_types({type::capture<A>()...}), result_type(type::capture<R & >()) { func = [f](void * const args[]) { return result::capture<R & >(f(get(args[I], tag<A>{})...));          }; }
    template<class F, class R, class... A, size_t... I> any_function(F f, tag<R &&>, tag<A...>, indices<I...>)  : parameter_types({type::capture<A>()...}), result_type(type::capture<R &&>()) { func = [f](void * const args[]) { return result::capture<R &&>(f(get(args[I], tag<A>{})...));          }; }
    template<class F,          class... A, size_t... I> any_function(F f, tag<void>, tag<A...>, indices<I...>)  : parameter_types({type::capture<A>()...}), result_type(type::capture<void>()) { func = [f](void * const args[]) { return                       f(get(args[I], tag<A>{})...), result{}; }; }
    template<class F, class R                         > any_function(F f, tag<R   >, tag<    >, indices<    >)  : parameter_types({                     }), result_type(type::capture<R   >()) { func = [f](void * const args[]) { return result::capture<R   >(f(                         ));          }; }
    template<class F, class R                         > any_function(F f, tag<R & >, tag<    >, indices<    >)  : parameter_types({                     }), result_type(type::capture<R & >()) { func = [f](void * const args[]) { return result::capture<R & >(f(                         ));          }; }
    template<class F, class R                         > any_function(F f, tag<R &&>, tag<    >, indices<    >)  : parameter_types({                     }), result_type(type::capture<R &&>()) { func = [f](void * const args[]) { return result::capture<R &&>(f(                         ));          }; }
    template<class F                                  > any_function(F f, tag<void>, tag<    >, indices<    >)  : parameter_types({                     }), result_type(type::capture<void>()) { func = [f](void * const args[]) { return                       f(                         ), result{}; }; }
